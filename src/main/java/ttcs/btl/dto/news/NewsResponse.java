...
public record NewsResponse(Long id, String img, String title, String des, LocalDateTime createdAt,
                           LocalDateTime updatedAt, Long fk_news_client_id) {
    public NewsResponse(NewsEntity newsEntity) {
        this(newsEntity.getId(), newsEntity.getImg(), newsEntity.getTitle(),
