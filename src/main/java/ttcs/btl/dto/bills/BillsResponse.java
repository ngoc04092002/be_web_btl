...
public record BillsResponse(Long id, String name, String phone, ClientEntity clientEntityBill,
                            LocalDateTime createdAt) {
    public BillsResponse(BillEntity billEntity) {
        this(billEntity.getId(), billEntity.getName(), billEntity.getPhone(),
